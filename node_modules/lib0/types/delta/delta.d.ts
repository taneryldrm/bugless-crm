 ...
 */
export class DeleteAttrOp<V = any, K extends string | number = string> {
    /**
     * @param {K} key
     * @param {V|undefined} prevValue
     * @param {Attribution?} attribution
     ...
     */
    _fingerprint: string | null;
    get $type(): s.Schema<DeleteAttrOp<{}, string | number>>;
    /**
     * @type {'delete'}
     */
    get type(): "delete";
...
export const $deleteAttrOp: s.Schema<DeleteAttrOp<{}, string | number>>;
export const $anyAttrOp: s.Schema<SetAttrOp<any, any> | DeleteAttrOp<{}, string | number> | ModifyAttrOp<any, string | number>>;
...
declare class DeltaData<Name extends string, Attrs extends { [K in string | number]: any; }, Children, Text extends boolean> {
     ...
     * >}
     */
    children: list.List<(Text extends true ? (RetainOp | TextOp | DeleteOp<{}>) : never) | (RetainOp | InsertOp<Children> | DeleteOp<any> | (Delta extends Children ? ModifyOp<Extract<Children, Delta>> : never))>;
    childCnt: number;
    /**
     * @type {any}
     */
